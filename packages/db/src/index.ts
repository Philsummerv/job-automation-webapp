...
// migrations/*.sql. Row shapes are re-exported from @jobassistui/shared.

import type { Profile, ActivityLogEntry } from "@jobassistui/shared";
...
export type { Profile, ActivityLogEntry } from "@jobassistui/shared";
